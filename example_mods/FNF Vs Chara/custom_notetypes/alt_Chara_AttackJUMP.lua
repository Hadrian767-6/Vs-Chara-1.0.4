function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'alt_Chara_AttackJUMP' then
...
attackAnimations = {'', 'alt-jumpAttackDOWN', 'alt-jumpAttackUP', ''}
function opponentNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'alt_Chara_AttackJUMP' then

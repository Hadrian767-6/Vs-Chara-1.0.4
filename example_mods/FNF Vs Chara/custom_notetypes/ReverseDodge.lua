function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'ReverseDodge' then
...
ECHO = false
dodgeAnimations = {'DodgeRIGHT', 'DodgeDOWN', 'DodgeUP', 'DodgeLEFT', 'DodgeJUMP'}
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'ReverseDodge' then

function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'OtherAttackBF' then
...
Atacks = {'DASH', 'THROW', '', 'DASH'}
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'OtherAttackBF' then
...
function noteMiss(id, noteData, noteType, isSustainNote)
	if noteType == 'OtherAttackBF' then
        ...
        doTweenAlpha('Hit', 'CHARA8', 0, 0.3, 'quadOut')
	end
end

function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Phantom_Attack' then
...
function opponentNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Phantom_Attack' then

        makeAnimatedLuaSprite('Phantom', 'characters/Chara', getProperty('dad.x')-86, getProperty('dad.y')-79)
        addAnimationByPrefix('Phantom', 'attackLEFT', 'Chara alt attack l', 20, false)
        addAnimationByPrefix('Phantom', 'attackDOWN', 'Chara alt attack d', 20, false)
        addAnimationByPrefix('Phantom', 'attackUP', 'Chara alt attack u', 20, false)
        addAnimationByPrefix('Phantom', 'attackRIGHT', 'Chara alt attack r', 20, false)
